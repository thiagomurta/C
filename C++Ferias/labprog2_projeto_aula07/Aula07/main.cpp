...
int main()
{
    ...
    */
    ...
    cout << "----------------------"<< endl;
    cout << "Número de nós na lista:" << L2.numNos() << endl;
    cout << "Índice do valor maior que 2: " << L2.buscaMaior(2) << endl;
    cout << "A média dos Nós é: " << L2.calculaMedia() << endl;
    L2.concatena(&l);
    L2.imprimir();
    cout << endl;
    ListaEncad* L3 = L2.partir(8);
    L2.imprimir();
    cout << endl;
    L3->imprimir();
    cout << endl;
    /*
    L2.limpar();
    cout << "Novo número de Nós: " << L2.numNos() << endl;
    */
